...
const nav = [
  ...
  { group: 'Promoções', items: [
    ...
    { to: 'cupons',      icon: Tag,         label: 'Meus Cupons' },
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="flex items-center justify-between px-4 md:px-6 py-3 bg-bg2 border-b border-border">
          <div className="flex items-center gap-3 flex-1 min-w-0 mr-2 md:mr-6">
            ...
            <div className="hidden sm:block flex-1 h-1.5 rounded-full bg-bg3 overflow-hidden max-w-[200px]">
              <div
                className="h-full rounded-full transition-all duration-700"
                style={{ width: `${tierProgress}%`, background: tierColor }}
              />
            </div>
            <span className="hidden sm:inline-block text-[10px] text-text3 flex-shrink-0">
