...
export default function MySales() {
  ...
  const blingActive = !!integrations?.find((i: any) => i.provider === 'BLING' && i.isActive);

  return (
    <div>
      <PageHeader title="Minhas Vendas" />

      {/* Acesso às notas fiscais — Bling se conectado, senão NFe.io */}
        ...
        <div className="flex-1 text-sm">
          ...
          {blingActive ? (
            <>
              ...
              >
                Abrir painel Bling <ExternalLink size={12} />
              </a>
            </>
          ) : (
            <>
