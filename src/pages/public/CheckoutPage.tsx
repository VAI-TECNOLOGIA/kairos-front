      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: 'radial-gradient(circle, rgba(0,85,254,0.15) 0%, transparent 70%)',
            pointerEvents: 'none',
          }} />
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{
              ...
              background: 'linear-gradient(135deg, #c8922a, #f5d06e, #b87d20)',
              display: 'grid', gridTemplateColumns: '1fr 1fr 1fr',
              gridTemplateRows: '1fr 1fr 1fr', gap: '2px', padding: '4px',
            }}>
              {[...Array(9)].map((_, i) => (
                <div key={i} style={{
                  background: i === 4 ? '#b87d20' : 'rgba(0,0,0,0.2)',
                  borderRadius: '1px',
                }} />
              ))}
            </div>
          ...
          <div style={{
            ...
            color: 'rgba(220,230,255,0.92)', fontWeight: 700,
          }}>
            {displayNumber}
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div style={{ flex: 1, minWidth: 0, marginRight: '16px' }}>
              <div style={{ fontSize: '8px', color: 'rgba(220,230,255,0.35)', textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: '3px' }}>
                Titular
              </div>
              <div style={{
                fontSize: '12px', fontWeight: 700, color: 'rgba(220,230,255,0.88)',
...
export default function CheckoutPage() {
  ...
  const payMutation = useMutation({
    mutationFn: async (formData: any) => {
      ...
      const payload: any = {
        ...
        customerDoc   : formData.customerDoc  || undefined,
    ...
    onSuccess: ({ data }) => {
      setResult(data);
      if (data.status === 'APPROVED') toast.success('Pagamento aprovado!');
    },
    onError: (err: any) => {
  ...
  // ── TELA BOLETO ──────────────────────────────────────────────
  if (result?.method === 'BOLETO' || result?.boletoUrl) return (
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="bg-bg2 border border-border rounded-2xl p-8 text-center">
  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        {/* Card do produto — layout Hotmart/Kiwify style */}
          ...
          <form onSubmit={handleSubmit(d => payMutation.mutate(d))} className="p-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2 sm:col-span-1">
                ...
                <input {...register('customerName', { required: 'Obrigatório' })}
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input {...register('customerEmail', { required: 'Obrigatório' })} type="email"
                  className="w-full bg-bg3 border border-border rounded-xl px-4 py-2.5 text-sm text-text placeholder:text-text3 outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition-all"
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input {...register('customerPhone', { required: 'Obrigatório' })}
                  className="w-full bg-bg3 border border-border rounded-xl px-4 py-2.5 text-sm text-text placeholder:text-text3 outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition-all"
            ...
            {method === 'CREDIT_CARD' && (
              <div className="bg-bg3 rounded-xl p-4 space-y-3 border border-border">
                ...
                {/* Cartão animado — abaixo dos campos */}
